import 'package:booking_hotel_app/color/colors.dart';
import 'package:booking_hotel_app/model/destination_model.dart';
import 'package:flutter/material.dart';
import 'package:readmore/readmore.dart';

class HotelDetalPage extends StatelessWidget {
  final Destination destination;
  const HotelDetalPage({super.key, required this.destination});
